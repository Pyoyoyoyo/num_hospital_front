...
export default function UsersPage() {
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        ...
        enqueueSnackbar('Хэрэглэгчдийг авахад алдаа гарлаа', {
          variant: 'error',
        });
      } finally {
        setLoading(false);
  ...
  const handleUpdateRoles = async () => {
    ...
    try {
      ...
      enqueueSnackbar('Хэрэглэгчийн эрх амжилттай шинэчлэгдлээ', {
        variant: 'success',
      });
      handleCloseEditDialog();
    } catch (error) {
      console.error('Error updating user roles:', error);
      enqueueSnackbar('Хэрэглэгчийн эрх шинэчлэхэд алдаа гарлаа', {
        variant: 'error',
      });
    }
  };
  ...
  const filteredUsers = useMemo(() => {
    ...
    return users.filter((user) =>
      user.sisiId.toLowerCase().includes(searchQuery.toLowerCase())
    );
  }, [users, searchQuery]);
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8 mb-8'>
        <div className='flex flex-col sm:flex-row justify-between items-center mb-6 gap-4'>
          ...
          <div className='relative w-full sm:w-64'>
            <input
              type='text'
              placeholder='Хэрэглэгчийн ID-аар хайх...'
              value={searchQuery}
              onChange={(e) => setSearchQuery(e.target.value)}
              className='w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm pl-10'
            />
              ...
              <tbody className='bg-white divide-y divide-gray-200'>
                {filteredUsers.length > 0 ? (
                  ...
                  <tr>
                    ...
                    >
                      {searchQuery
                        ? `"${searchQuery}" гэсэн хайлттай хэрэглэгч олдсонгүй.`
                        : 'Хэрэглэгч олдсонгүй.'}
                    </td>
                  </tr>
                )}
                    ...
                    <div className='mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full'>
                      ...
                      <div className='mt-2'>
                        <p className='text-sm text-gray-500 mb-4'>
                          ...
                          хэрэглэгчийн эрхийг сонгоно уу.
                        </p>
                    ...
                    <div className='mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left'>
                      ...
                      <div className='mt-2'>
                        <p className='text-sm text-gray-500'>
                          ...
                          хэрэглэгчийг устгахдаа итгэлтэй байна уу? Энэ үйлдлийг
                          буцаах боломжгүй.
                        </p>
                      </div>
                    </div>
